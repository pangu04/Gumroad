      ...
      <section className="border-b-2 border-black px-8 py-20 bg-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p
            ...
            style={{ fontFamily: 'Space Grotesk, sans-serif' }}
          >
            Gumroad is a complete creator commerce platform. Products, payments, emails, analytics — all in one place.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p
                ...
                style={{ fontFamily: 'Space Grotesk, sans-serif' }}
              >
                Create a product, set your price, and start selling. Gumroad handles the checkout, delivery, and payments. You focus on creating.
              </p>
              ...
              <div className="border-2 border-black rounded-2xl overflow-hidden">
                ...
                <div className="bg-white p-6">
                  <div className="border-2 border-black rounded-xl p-4 mb-3">
                    <p className="text-xs font-bold text-gray-400 mb-1" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>PRODUCT NAME</p>
                    <p className="font-bold text-black" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Complete UI Kit 2024</p>
                  </div>
                  <div className="border-2 border-black rounded-xl p-4 mb-3">
                    <p className="text-xs font-bold text-gray-400 mb-1" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>PRICE</p>
                  ...
                  <div className="border-2 border-black rounded-xl p-4 mb-4">
                    <p className="text-xs font-bold text-gray-400 mb-1" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>FILE</p>
          ...
          <div className="grid grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p
                ...
                style={{ fontFamily: 'Space Grotesk, sans-serif' }}
              >
                Our analytics dashboard shows you everything that matters: revenue trends, top products, customer sources, and conversion rates.
              </p>
              <ul className="space-y-4">
                {[
      ...
      <section className="border-t-2 border-black bg-[#FF90E8] px-8 py-20 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p
            ...
            style={{ fontFamily: 'Space Grotesk, sans-serif' }}
          >
            Start selling in minutes. No technical knowledge required.
          </p>
          <Link
            to="/start-selling"
